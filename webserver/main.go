...
var context = []byte("2017-blockchain-summer-school-demo")
...
func main() {
	if len(os.Args) != 3 {
		log.Fatal("go run main.go statement.txt tracks.json")
	}
...
func vote(w http.ResponseWriter, r *http.Request) {
	...
	if err := database.Save(dbName); err != nil {
		log.Error(err)
	}
	w.WriteHeader(200)
}
